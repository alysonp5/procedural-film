// host.cjs : run the film's audio code (lib.js, timeline.js, foley.js, music.js) in Node, no browser.
...
const OUT = '/tmp/cq2/audio';

/** A fresh FILM with the audio stack loaded. opts.foley false leaves foley.js out. */
function load(opts = {}) {
  ...
  sb.FILM = {};
  vm.createContext(sb);
  const files = ['lib.js', 'timeline.js', ...(opts.foley === false ? [] : ['foley.js']), 'music.js'];
