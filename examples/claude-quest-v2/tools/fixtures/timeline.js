...
FILM.TIMELINE = {
  ...
  shots: [
    ...
    { id: 'instrument', file: '05-instrument.js', start: 8, end: 10, mode: 'raw', brief: 'Instrument mode: a live test clip through the brass porthole, then through the eyepiece.' },
  ],
  cues: [
    { t: 0, kind: 'open' },
    { t: 2.5, kind: 'cut' },
